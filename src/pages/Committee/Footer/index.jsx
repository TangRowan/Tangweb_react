...
export default function UFooter() {
  ...
  if(userstate.userinf.Email==='-1'){
    openmsg('error','','Please login!');
      navigate("/login");
    }else if(userstate.userinf.Committee!=='1'){
    openmsg('error','','You do not have access!');
    navigate("/user");
    }
    else if(userstate.userinf.Password==='40bd001563085fc35165329ea1ff5c5ecbdbbeef'){
      openmsg('warning','','Your password is not secured. Please reset your password!');
    navigate("/committee/change_password");
    }
    },[]);
