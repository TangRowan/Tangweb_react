...
class Myrequest extends Component {
  ...
  componentDidMount(){
    axios.get(this.props.url+'/IEEEbackend/searchdata.php?!='+('3')).then(
      response => {
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        key: 'ReportYear',
        width: 120 ,
        ...this.getColumnSearchProps('ReportYear'),
      },
      {
        title: 'Write Time',
    ...
    return (
      ...
      <Card className='ncenter' title="Browse Reports" bordered={false}>
