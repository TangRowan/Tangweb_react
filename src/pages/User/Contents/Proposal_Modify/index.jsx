...
import { Form, Input, Button,  Card,notification,Select,Spin ,Col,Row} from 'antd'
...
export default function Oprop() {
  ...
  const onFinish = (values) => {
      ...
      axios.post(userstate.Backurl.url+'/IEEEbackend/propose.php',qs.stringify({data:'3|'+
      ...
      values.TY+'|'+values.TYB+'|'+values.TYA+'|'
        ...
        response => {
            ...
            if(response.data['success']===1){
              ...
              setload(false);
              openmsg('success','','The modification of the proposal/project is successfully submitted');
              navigate(-1);
            }
  ...
  <Card className='ncenter' title="Modify Proposed" bordered={false}>
    <div className='container'>
      ...
      <Form.Item wrapperCol={{ span: 16}}>
        <Input.Group compact>
          ...
          >
            <Input bordered={false} maxLength='4' />
          </Form.Item>
          <Form.Item
